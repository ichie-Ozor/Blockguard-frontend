...
const fetchEventData = async (eventId: string) => {
  ...
  // Assuming you're using an API or database that provides event data
  return {
...
const EventSinglePage = () => {
  const router = useRouter();
  const { eventId } = router.query; // Extract eventId from the URL query parameter

  // Make sure eventId is available before trying to fetch the event data
  ...
  // Return loading state while event data is being fetched
  if (!eventData) {
